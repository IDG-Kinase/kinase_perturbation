---
title: "Genome Clustering - Pathway Enrichment Analysis - MSigDB Hallmark"
...
cluster_output_file_name = paste0('full_genome_clusters_', number_of_clusters, '.csv')
...
tree_cut = cutree(genome_cluster_ratio,k = number_of_clusters) %>% 
	...
	write_csv(here('cluster_sets',cluster_output_file_name))
