...
write_csv(full_DESeq,here('DESeq_results/HCC1806_full_DESeq2_single_DESeq.csv.gz'))
write_csv(summary_stats,here('DESeq_results/HCC1806_DESeq2_summary_single_DESeq.csv'))
toc()
```
