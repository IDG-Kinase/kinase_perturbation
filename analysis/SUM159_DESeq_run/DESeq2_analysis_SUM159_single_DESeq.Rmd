...
exp_info = tribble(
	...
	here('salmon_alignments/batch_02/rep_01/Rux/quant.sf'), 2, 1, "Ruxolibinib",
	here('salmon_alignments/batch_02/rep_02/Rux/quant.sf'), 2, 2, "Ruxolibinib",
...
write_csv(full_DESeq,here('DESeq_results/SUM159_full_DESeq2_single_DESeq.csv.gz'))
write_csv(summary_stats,here('DESeq_results/SUM159_DESeq2_summary_single_DESeq.csv'))
toc()
```
